...
Used by `stitch_rag_bridge.py` for `/api/auth/google/*`, sessions, and `/api/subscriptions/from-gmail`. Discoverability in this repo: **[docs/local-oauth-playbook/](docs/local-oauth-playbook/)** (pointer). Full checklist: **[github.com/RanneG/local-oauth-playbook](https://github.com/RanneG/local-oauth-playbook)**.
